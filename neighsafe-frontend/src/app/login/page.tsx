  ...
  return (
    <div className='relative bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#020617] w-screen h-screen flex justify-center items-center overflow-hidden'>
      ...
      ">
        ...
        {/* LEFT */}
        <div className='w-full md:w-1/2 flex flex-col justify-center px-8 py-10 bg-white/5 backdrop-blur-lg'>
          
          <h1 className='text-4xl text-center mb-2 gradient'>Neigh Safe</h1>
          <h1 className='text-3xl text-center text-white mb-2'>Welcome Back</h1>
          <p className='text-center text-gray-400 mb-8'>
            Protegendo a sua vizinhança em tempo real
          </p>
